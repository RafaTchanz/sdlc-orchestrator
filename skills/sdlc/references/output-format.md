...
- `task-{slug}.md` — Title, Context, Definition of Ready, Acceptance Criteria, Technical Notes, Definition of Done, Open Questions. Each task gets an auto-generated ID in the corresponding row of `docs/sdlc/tasks/INDEX.md` (`ID | Title | Summary | Status | Depends-on`). (Full spec: `sdlc-task-writer.md`.)
