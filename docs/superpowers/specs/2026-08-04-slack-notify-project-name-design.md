...
**Date**: 2026-08-04
**Status**: Implemented (`agents/sdlc-slack-notify.md`, `skills/sdlc/SKILL.md`, `skills/sdlc/references/phases.md`) — see `docs/superpowers/plans/2026-08-04-slack-notify-project-name.md`.
